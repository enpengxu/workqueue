...
#define INIT_DELAYED_WORK(_work, _func)				\
	do {											\
		...
		INIT_LIST_HEAD(&(_work)->work.list);		\
	} while (0)
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/hardware/gpu/drm/server-3.12.2/include/qnx/workqueue.h $ $Rev: 779374 $")
#endif
